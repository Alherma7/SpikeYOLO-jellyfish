...
class BaseTrainer:
    ...
    def _setup_train(self, world_size):
        ...
        if self.amp and RANK in (-1, 0):  # Single-GPU and DDP
            ...
            self.amp = torch.tensor(True, device=self.device) #网络原因，下载权重可能很久
    ...
    def check_resume(self, overrides):
        ...
        if resume:
            try:
                ...
                ckpt_args = attempt_load_weights(last).args  #在这里会把device一起读取
                ckpt_args['device'] = overrides['device']  #卡号不变
